...
def svm_weather_prediction_training_without_undersampling(request):
    ...
    with open('/tmp/SVM_Model_without_undersampling.pkl', 'wb') as files:
        pickle.dump(model, files)
    files.close()
    svm_model_trained = bucket.blob('SVM_Model/SVM_Model_without_undersampling.pkl')
    svm_model_trained.upload_from_filename('/tmp/SVM_Model_without_undersampling.pkl')
