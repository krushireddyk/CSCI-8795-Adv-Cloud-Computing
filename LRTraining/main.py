...
def logistic_regression(request):
    ...
    with open('/tmp/logistic_regression.pkl', 'wb') as files:
        pickle.dump(model, files)
    files.close()
    svm_model_trained = bucket.blob('logistic_regression_Model/logistic_regression.pkl')
    svm_model_trained.upload_from_filename('/tmp/logistic_regression.pkl')
